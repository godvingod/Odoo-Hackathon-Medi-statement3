...
drop policy if exists "Users can view available items" on items;
...
drop policy if exists "Users can insert swap requests" on swaps;
drop policy if exists "Users can update their swaps" on swaps;
drop policy if exists "Admins can view all swaps" on swaps;
...
drop policy if exists "Users can view admin actions" on admin_actions;
drop policy if exists "Users can insert admin actions" on admin_actions;
